...
This directory contains built-in skills that extend necobot's capabilities.
...
When skills reference large local documentation or logs, prefer necobot's built-in
