...
from necobot.agent.autocompact import AutoCompact
from necobot.agent.context import ContextBuilder
from necobot.agent.hook import AgentHook, AgentHookContext, CompositeHook
from necobot.agent.memory import Consolidator, Dream
from necobot.agent.runner import _MAX_INJECTIONS_PER_TURN, AgentRunner, AgentRunSpec
...
from necobot.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
from necobot.agent.tools.message import MessageTool
from necobot.agent.tools.notebook import NotebookEditTool
from necobot.agent.tools.registry import ToolRegistry
from necobot.agent.tools.search import GlobTool, GrepTool
from necobot.agent.tools.shell import ExecTool
from necobot.agent.tools.spawn import SpawnTool
from necobot.agent.tools.web import WebFetchTool, WebSearchTool
from necobot.bus.events import InboundMessage, OutboundMessage
from necobot.bus.queue import MessageBus
from necobot.command import CommandContext, CommandRouter, register_builtin_commands
from necobot.config.schema import AgentDefaults
from necobot.providers.base import LLMProvider
from necobot.session.manager import Session, SessionManager
from necobot.utils.document import extract_documents
from necobot.utils.helpers import image_placeholder_text
from necobot.utils.helpers import truncate_text as truncate_text_fn
from necobot.utils.runtime import EMPTY_FINAL_RESPONSE_MESSAGE

if TYPE_CHECKING:
    from necobot.config.schema import ChannelsConfig, ExecToolConfig, WebToolsConfig
...
class AgentLoop:
    ...
    def __init__(
        ...
        from necobot.config.schema import ExecToolConfig, WebToolsConfig
        ...
        # NECOBOT_MAX_CONCURRENT_REQUESTS: <=0 means unlimited; default 3.
        _max = int(os.environ.get("NECOBOT_MAX_CONCURRENT_REQUESTS", "3"))
    ...
    async def _connect_mcp(self) -> None:
        ...
        from necobot.agent.tools.mcp import connect_mcp_servers
    ...
    def _tool_hint(tool_calls: list) -> str:
        ...
        from necobot.utils.tool_hints import format_tool_hints
