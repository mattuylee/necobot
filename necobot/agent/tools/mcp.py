"""MCP client: connects to MCP servers and wraps their tools as native necobot tools."""
...
class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a necobot Tool."""
...
class MCPResourceWrapper(Tool):
    """Wraps an MCP resource URI as a read-only necobot Tool."""
...
class MCPPromptWrapper(Tool):
    """Wraps an MCP prompt as a read-only necobot Tool."""
