...
from necobot.agent.tools.base import Tool, tool_parameters
from necobot.agent.tools.schema import IntegerSchema, StringSchema, tool_parameters_schema
from necobot.utils.helpers import build_image_content_blocks

if TYPE_CHECKING:
    from necobot.config.schema import WebSearchConfig
        ...
        try:
            async with httpx.AsyncClient(proxy=self.proxy, follow_redirects=True, max_redirects=MAX_REDIRECTS, timeout=15.0) as client:
                async with client.stream("GET", url, headers={"User-Agent": USER_AGENT}) as r:
                    from necobot.security.network import validate_resolved_url
